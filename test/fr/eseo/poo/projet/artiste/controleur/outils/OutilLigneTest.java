...
public class OutilLigneTest {
         ...
         */
        private Ligne ligneReferenceDrag;
        ...
        public static Collection<Object[]> dt() {
                final Object[][] data = new Object[][] {
                                // Test 0
                                { new Ligne(new Coordonnees(0, 30)), new Ligne(new Coordonnees(250, 240), 71, 81), 1 },
                                // Test 1
                                { new Ligne(new Coordonnees(30, 30)), new Ligne(new Coordonnees(250, 240), 0, 110), 2 },
                                // Test 2
                                { new Ligne(new Coordonnees(60, 30)), new Ligne(new Coordonnees(250, 240), -71, 81),
                                                3 },
                                // Test 3
                                { new Ligne(new Coordonnees(90, 30)), new Ligne(new Coordonnees(250, 240), -100, 10),
                                                4 },
                                // Test 4
                                { new Ligne(new Coordonnees(120, 30)), new Ligne(new Coordonnees(250, 240), -71, -61),
                                                5 } };
        ...
        public void testOutilLigneGlisseClick() {
                ...
                this.outil.mousePressed(new MouseEvent(this.frame.getComponent(0), MouseEvent.MOUSE_PRESSED, 0,
                                MouseEvent.BUTTON1_DOWN_MASK, 250, 250 - 10, 1, false, MouseEvent.BUTTON1));
                this.outil.mouseReleased(new MouseEvent(this.frame.getComponent(0), MouseEvent.MOUSE_RELEASED, 0,
                                MouseEvent.BUTTON1_DOWN_MASK, 250 + largeur, 250 + hauteur, 1, false,
                                MouseEvent.BUTTON1));
